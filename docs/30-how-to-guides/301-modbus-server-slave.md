...
**Once again, if you're just looking for a simple usage, you can stop reading here.** The following sections cover advanced use cases with handlers for scenarios requiring more flexibility over request processing by the `Server`.
